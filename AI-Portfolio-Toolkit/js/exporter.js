...
const Exporter = {
    generatePPT: (data) => {
        ...
        const themeColors = {
            ...
            health: { accent: "22D3EE", sub: "10B981" },
            esports: { accent: "8B5CF6", sub: "22D3EE" }
        };
        ...
        const themeBgColors = {
            ...
            health: { dark: "062B33", light: "ECFEFF" },
            esports: { dark: "160B35", light: "F5F3FF" }
        };
...
,
    ...
    generateDOCX: (data) => {
        ...
        const theme = {
            ...
            health:{accent:'0891B2',accent2:'10B981',dark:'062B33',side:'0E7490',soft:'ECFEFF',text:'0F172A'},
            esports:{accent:'7C3AED',accent2:'22D3EE',dark:'160B35',side:'6D28D9',soft:'F5F3FF',text:'111827'}
        ...
        extraBody += sectionCards(labels.cta, pickText('cta'));
        ...
        const documentXml = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main"><w:body>${body}<w:sectPr>${pageSz}<w:pgMar w:top="720" w:right="720" w:bottom="720" w:left="720"/></w:sectPr></w:body></w:document>`;
